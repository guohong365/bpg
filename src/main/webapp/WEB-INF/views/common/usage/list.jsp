                    ...
                    <div class="col-xs-12">
                      <form:form class="form-horizontal" role="form" modelAttribute="queryInput" action="#">
                        ...
                        <div class="row">
                          <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                              <form:label path="queryUseTimeFrom" cssClass="control-label col-xs-12 col-sm-4">使用时间：</form:label>
                              <div class="input-daterange input-group">
                                <form:input cssClass="form-control" path="queryUseTimeFrom" />
                                <span class="input-group-addon">至 </span>
                                <form:input cssClass="form-control" path="queryUseTimeTo" />
