          ...
          <div class="row">
            <div class="col-xs-12 col-sm-6 col-lg-4">
              <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8">
                  <form:input path="queryHotelName" cssClass="form-control" />
                </div>
              </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-lg-4">
            ...
            <div class="col-xs-12 col-sm-6 col-lg-4">
              <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8">
                  <form:checkboxes items="${_QUERY_STATE}" itemLabel="value" itemValue="code" path="queryState"/>
                </div>
              </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-lg-4">
              <div class="form-group">
                <form:label path="queryGeneratedTimeFrom" cssClass="col-xs-12 col-sm-4 control-label">账单时间：</form:label>
                <div class="col-xs-12 col-sm-8">
