                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-6">
                        <div class="form-group">
                          ...
                          <div class="col-xs-12 col-sm-8">
                            <p class="form-control-static blue"><fmt:formatNumber type="currency" pattern="￥.00" value="${detailInput.income}" /> </p>
                          </div>
                        </div>
                      </div>
                      <div class="col-xs-12 col-sm-6">
                        <div class="form-group">
                          ...
                          <div class="col-xs-12 col-sm-8">
                            <p class="form-control-static blue"><fmt:formatNumber type="currency" pattern="￥.00" value="${detailInput.payable}" /></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-xs-12 col-sm-6">
                        <div class="form-group">
                          ...
                          <div class="col-xs-12 col-sm-8">
                            <p class="form-control-static blue"><fmt:formatNumber type="percent"  value="${detailInput.ratio}" /></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-xs-12 col-sm-6">
