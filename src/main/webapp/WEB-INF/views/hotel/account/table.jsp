    ...
    <table class="table table-striped table-bordered table-hover dataTable no-footer">
      ...
      <tbody>
        <c:forEach var="item" items="${records}">
          <tr>
            <td>
              <fmt:formatDate value="${item.generatedTime}" pattern="yyyy-MM-dd HH:mm:ss" />
            </td>
            <td>
              <fmt:formatNumber value="${item.income}" currencySymbol="￥" type="currency" minFractionDigits="2" />
            </td>
            <td>
              <fmt:formatNumber value="${item.basicCharge}" currencySymbol="￥" type="currency" minFractionDigits="2" />
            </td>
            <td>
              <fmt:formatNumber value="${item.rent}" currencySymbol="￥" type="currency" minFractionDigits="2" />
            </td>
            <td>${item.state}</td>
            <td>
            ...
            <td>
              <fmt:formatDate value="${item.verifyTime}" pattern="yyyy-MM-dd HH:mm:ss" />
            </td>
